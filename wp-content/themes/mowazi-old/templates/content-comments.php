...
<div class="view-content__comments_container">
    ...
    <div class="comments-container">
        <!-- write your comment -->
        <form id="formComment_<?php echo $post_id; ?>" data-bv-live="disabled" data-bv-onsuccess="addComment" data-post="<?php echo $post_id; ?>">
            ...
            <button type="submit" class="btn btn-outline-secondary btn-sm">انشر</button>
        </form>
            ...
            foreach ($post_comments as $post_comment_id => $post_comment) {
                ...
                if ($comment_author) {
                    ...
                    <div class="card card-comment">
                        ...
                        <form id="formComment_<?php echo $post_comment_id; ?>" data-bv-live="disabled" data-bv-onsuccess="addComment" data-post="<?php echo $post_id; ?>" data-parent="<?php echo $post_comment_id; ?>">
                            <div class="form-group form-group_comment">
                                <div class="avatar avatar-xs" <?php if ($cur_user_avatar) { echo 'data-avatar="' . $cur_user_avatar . '"'; } ?>></div>
                                <textarea name="comment" class="form-control" placeholder="أكتب تعليق…" data-bv-notempty="true" data-bv-notempty-message="هذا الحقل لا يمكن ان يكون فارغا"></textarea>
                            </div>
