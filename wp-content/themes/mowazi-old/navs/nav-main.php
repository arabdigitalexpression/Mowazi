...
<header class="main-header">
    <div class="container-fluid">
        <div class="header-wrapper">
            ...
            <div>
                <a class="btn btn-pink" href="<?php echo get_permalink(10); ?>" data-page="10">تسجيل الاشتراك</a>
                <a class="btn btn-secondary" href="<?php echo get_permalink(8); ?>" data-page="8">تسجيل الدخول</a>
