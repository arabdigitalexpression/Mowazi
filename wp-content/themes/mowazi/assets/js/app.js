				...
				var el = $(this),
					...
					mainComponent = $(
						'<div class="workshop_partition_content ' +
							...
							'</span></div><div><a style="cursor: pointer;" onclick="toggleExpand(this)" class="expand-collapse-component" title="expand/collapse item"><i class="icon-notes"></i></a><a href="#commentsSidebar"><i class="icon-comment"></i></a><a href="#materialSidebar"><i class="icon-material"></i></a><a href="#attachesSidebar"><i class="icon-sources-alt"></i></a><a href="#" title="delete entry" class="delete-entry"><i class="icon-delete"></i></a></div></div><div class="workshop-content"><div class="p-0"><div class="hyperlink"><div><input type="text" name="hyperlink"><button class="attach"><i class="icon-attach-alt"></i></button></div></div><form data-bv-live="disabled"></form><div class="row no-gutters default"><div class="col-md-1"><input class="form-control workshop-input workshop-input_number" placeholder="0"></div><div class="col-md-3"><textarea class="form-control workshop-input workshop-input_title" placeholder="عنوان"></textarea></div><div class="col-md-6"><textarea class="form-control workshop-input workshop-input_content" placeholder="تفاصيل"></textarea></div> <div class="col-md-2"><div class="form-group"><textarea class="form-control workshop-input workshop-input_notes" name="" placeholder="ملاحظات"></textarea></div></div></div></div></div></div></div>'
					),
	...
	var stamp = 'panel_' + new Date().getTime(),
		mainComponent = jQuery(
			'<div class="workshop_partition_content whiteblue-color" id="' +
				stamp +
				'"><div class="header handle"><div><a href="#"><i class="icon-drag"></i></a><span>نشاط</span></div><div><a style="cursor: pointer;" onclick="toggleExpand(this)" class="expand-collapse-component" title="expand/collapse item"><i class="icon-notes"></i></a><a href="#notesSidebar"><i class="icon-notes"></i></a><a href="#commentsSidebar"><i class="icon-comment"></i></a><a href="#materialSidebar"><i class="icon-material"></i></a><a href="#attachesSidebar"><i class="icon-sources-alt"></i></a><a href="#" title="delete entry" class="delete-entry"><i class="icon-delete"></i></a></div></div><div class="workshop-content"><div class="p-0"><form data-bv-live="disabled"></form><div class="row no-gutters default"><div class="col-md-1"><input class="form-control workshop-input workshop-input_number" placeholder="0"></div><div class="col-md-3"><textarea class="form-control workshop-input workshop-input_title" placeholder="عنوان"></textarea></div><div class="col-md-6"><textarea class="form-control workshop-input workshop-input_content" placeholder="تفاصيل"></textarea></div><div class="col-md-2"><div class="form-group"><textarea class="form-control workshop-input workshop-input_notes" placeholder="ملاحظات"></textarea></div></div></div></div></div></div></div>'
		),
